...
import core.loss
from core.losses_metrics import FocalLoss, McDiceLoss, SurfaceLoss, iou
...
def train(args):
    ...
    mcdl = core.losses_metrics.McDiceLoss
    sl = SurfaceLoss(sw = .001)
    loss_fn = mcdl
    ...
    for epoch in range(args.n_epoch):
        ...
        for i, (images, labels) in enumerate(trainloader):
            ...
            if i in numbers:
                ...
                for channel in range(0, len(class_names)):
                    ...
                    writer.add_image('train_classes/_{class_names[channel]}', tb_channel, epoch + 1)
        ...
        if args.per_val != 0:
                ...
                for i_val, (images_val, labels_val) in tqdm(enumerate(valloader)):
                    ...
                    if i_val in numbers:
                        ...
                        for channel in range(0, len(class_names)):
                            ...
                            writer.add_image('val_classes/_{class_names[channel]}', tb_channel, epoch + 1)
            ...
            if (epoch+1) % 5 == 0:
                model_dir = os.path.join(
                    log_dir, "{args.arch}_ep{epoch+1}_model.pkl")
                torch.save(model, model_dir)
